...
================================================================================
                    LAUNCHPILOT AI - EXECUTIVE DOSSIER REPORT
================================================================================
Report Title: ${rep.title}
Generated Date: ${rep.date}
Report Type: ${rep.type}
Page Count: ${rep.pages} Pages
Status: ${rep.status}

--------------------------------------------------------------------------------
EXECUTIVE SUMMARY
--------------------------------------------------------------------------------
This dossier contains actionable competitive research, go-to-market strategy,
persona demographics, pricing tier analysis, and pitch deck blueprints.

================================================================================
Generated by LaunchPilot AI Platform
================================================================================
`;
    ...
    link.href = url;
    link.download = `${rep.title.replace(/[^a-zA-Z0-9]/g, '_')}_Dossier.txt`;
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    URL.revokeObjectURL(url);

    showToast(`Downloaded dossier: ${rep.title}`);
  };
